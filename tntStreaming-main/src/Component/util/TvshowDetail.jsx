...
import { useGetTvDetialQuery } from "../../app/moviApi";
...
function MovieDetails() {
  const { id } = useParams();
  const { data } = useGetTvDetialQuery(id);
  ...
  return (
    <section className="relative ">
      ...
      <div className="absolute top-28 left-[18%] flex items-center blurDetail p-5">
        <div>
          <img
            className="w-[35vh] h-auto rounded-lg"
            src={`https://image.tmdb.org/t/p/w780/${data?.poster_path}`}
            alt=""
          />
        </div>
        <div className="absolute  left-[30%] lg:left-[28%]">
